...
const create_abyss_rank_dto_1 = require("./dto/create-abyss-rank.dto");
...
let AbyssRanksController = class AbyssRanksController {
    ...
    create(createAbyssRankDto) {
        return this.abyssRanksService.create(createAbyssRankDto);
    }
    findAll() {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_abyss_rank_dto_1.CreateAbyssRankDto]),
    __metadata("design:returntype", void 0)
], AbyssRanksController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
